...
void save();
void load();
void player1(char field[3][3], int rows, int columns);
void player2(char field[3][3], int rows, int columns);
bool file_exists(string path); // true

int checkVictory(char field[3][3], int rows, int columns) {
